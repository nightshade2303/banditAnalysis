...
filepath = 'L:/4portProb_simulations/model_parameters_20250826/thompson_mod_first_block_bads'
options = {}
results = {}
tic()
for animal in animals:
    ...
    def fun_for_pybads(x):
        return nllThompsonModified(x, data, extra_params)
    for n in range(n_optim):
        # run multiple optimizations
        print('Running optimization ' + str(n) + '...')
        options['random_seed'] = n
        bads = BADS(fun_for_pybads, None, [1, 1, 0, 0], [10, 10, 1, 1], options = options)
