...
import numpy as np
import pandas as pd
from qlfittingFunctions_20250319 import nllmatQlearning_sticky
...
for rnn in range(1, 6):
    ...
    def fun_for_pybads(x):
        return nllmatQlearning_sticky(x, data, extra_params)
    for n in range(n_optim):
        ...
        with open(fr'L:\4_armed_bandit_metaRL\Unstructured_net\stickyalphamatql.csv', 'a') as f:
