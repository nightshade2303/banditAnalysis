...
import numpy as np
import pandas as pd
from qlfittingFunctions_20250319 import nllstickyQlearning
...
for rnn in range(1, 6):
    ...
    for n in range(n_optim):
        ...
        bads = BADS(fun_for_pybads, None, [0.0, 0.0015, 0.0], [1.0, 100, 1.0], options=options)
        ...
        with open(fr'L:\4_armed_bandit_metaRL\Unstructured_net\stickyql.csv', 'a') as f:
